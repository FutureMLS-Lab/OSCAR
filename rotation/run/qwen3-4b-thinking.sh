#!/usr/bin/env bash
# Qwen3-4B-Thinking-2507 -- dense MHA.
source "$(dirname "$0")/_common.sh"
ROT_DIR="${ROT_DIR:-$ZOO/Qwen3-4B-Thinking-2507/seq20000_prompt83_group128}"; need_rot "$ROT_DIR"
export ROT_DIR MODEL="${MODEL:-Qwen/Qwen3-4B-Thinking-2507}" TP_SIZE="${TP_SIZE:-1}"
