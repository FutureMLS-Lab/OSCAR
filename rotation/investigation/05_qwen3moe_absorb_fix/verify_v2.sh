...
run_arm bf16 SGLANG_ALLOW_OVERWRITE_LONGER_CONTEXT_LEN=1 -- --cuda-graph-max-bs 16
run_arm int2_noabsorb "${OSCAR_ENV[@]}" SGLANG_OSCAR_ABSORB_V_ROTATION=0 -- --kv-cache-dtype int2 --kv-cache-quant-group-size 128 --cuda-graph-max-bs 16
...
run_arm int2_absorb_nograph "${OSCAR_ENV[@]}" SGLANG_OSCAR_ABSORB_V_ROTATION=1 -- --kv-cache-dtype int2 --kv-cache-quant-group-size 128 --disable-cuda-graph
echo V2_DONE
