...
run_arm () {
  ...
  SGLANG_MIXED_KV_HP_MAX_SPLITS=8 SGLANG_MIXED_KV_PREFIX_TOKENS=1024 SGLANG_MIXED_KV_HP_PREFIX_POOL_TOKENS=131072 SGLANG_MIXED_KV_RECENT_TOKENS=256 \
  ...
  SGLANG_OSCAR_K_ROTATION_PATH=$KROT SGLANG_OSCAR_V_ROTATION_PATH=/home/charlie/CoQuant/.RUD/hybridmodel-testing/work/CoQuant/rotation/OSCAR-RotationZoo/Qwen3-8B/seq20000_prompt83_group128/v_rotation_sst_r_h_pbr.pt \
  python -m sglang.launch_server --model-path "$MODEL" --served-model-name q3 \
    ...
    --mem-fraction-static 0.68 --max-running-requests 4 --disable-cuda-graph \
...
run_arm q38b_tiny /home/charlie/CoQuant/.RUD/hybridmodel-testing/work/CoQuant/rotation/OSCAR-RotationZoo/Qwen3-8B/seq20000_prompt83_group128/k_rotation_qqt_r_h_pbr.pt
echo V12_DONE
