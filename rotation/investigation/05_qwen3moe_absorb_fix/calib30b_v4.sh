...
export TRITON_CACHE_DIR=/tmp/triton_calib4; mkdir -p $TRITON_CACHE_DIR
...
MAX_RUNNING_REQUESTS=8 MAX_QUEUED_REQUESTS=16 EXTRA_SERVER_ARGS="--context-length 4096" \
DUMP_KVCACHE_TOKENS=30000 PORT=31622 DIST_PORT=41622 \
