...
run_arm q38b_freshhad $INV/rotations/hadamard_36L.pt $INV/rotations/hadamard_36L.pt
run_arm q38b_zoo $ZOO/k_rotation_qqt_r_h_pbr.pt $ZOO/v_rotation_sst_r_h_pbr.pt
echo V4_DONE
