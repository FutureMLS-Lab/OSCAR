...
class Envs:
    ...
    # DeepGemm
    # Kimi-K3 flags, carried at UPSTREAM'S defaults. The values are copied
    # rather than chosen: picking our own would silently serve K3 with a
    # different configuration than the one upstream scores 95.83 with.
