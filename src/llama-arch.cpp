...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_ATTN_K_ROT,                             "blk.%d.attn_k_rot" },
    { LLM_TENSOR_ATTN_V_ROT,                             "blk.%d.attn_v_rot" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_ATTN_K_ROT,                 {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_V_ROT,                 {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
